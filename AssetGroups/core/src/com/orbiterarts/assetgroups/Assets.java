...
public class Assets implements Disposable, AssetErrorListener{
    ...
    public void loadGroup(String groupName){
        ...
        if(assets != null){
            for(Asset asset : assets){
                ...
                //Gdx.app.log(TAG,"type: "+asset.type);
                //Gdx.app.log(TAG,"path: "+asset.path);
                manager.load(asset.path,asset.type,asset.parameters);
                Gdx.app.log(TAG,"FINISHED LOADING "+asset.path);
            }
        }else{
    ...
    public void error(AssetDescriptor asset, Throwable throwable) {
        ...
        Gdx.app.log(TAG,"error loading "+asset.fileName+" messenger: "+throwable.getMessage());
    ...
    private void loadGroups(String assetFile) {
        ...
        try{
            ...
            JsonValue.JsonIterator groupIter = root.iterator();

            while(groupIter.hasNext()){
                JsonValue groupValue = groupIter.next();
                ...
                JsonValue.JsonIterator assetIter = groupValue.iterator();

                while(assetIter.hasNext()){
                    JsonValue assetValue = assetIter.next();
